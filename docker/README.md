...
Image Docker qui compile les plugins user contre la dylib pré-buildée du moteur. Pour la marketplace V2-V3 (revshare 70/30 école Technofutur).
...
| **V2 M3** (UGC Hub Marketplace) | `plugin-builder` actif. Étudiants Technofutur publient via cette infra. |
