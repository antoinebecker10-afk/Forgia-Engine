//! forgia-pp-distortion — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpDistortionPlugin);
//! commands.spawn((Camera3d::default(), DistortionSettings::default()));
//! ```
...
pub struct ForgiaPpDistortionPlugin;

impl Plugin for ForgiaPpDistortionPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<DistortionSettings>::default());
    }
}
