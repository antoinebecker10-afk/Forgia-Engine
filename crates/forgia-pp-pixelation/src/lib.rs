//! forgia-pp-pixelation — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpPixelationPlugin);
//! commands.spawn((Camera3d::default(), PixelationSettings::default()));
//! ```
...
pub struct ForgiaPpPixelationPlugin;

impl Plugin for ForgiaPpPixelationPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<PixelationSettings>::default());
    }
}
