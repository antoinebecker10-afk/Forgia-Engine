//! forgia-pp-bloom — Post-process effect.
//!
...
impl FullscreenMaterial for BloomSettings {
    fn fragment_shader() -> ShaderRef {
        "shaders/post_process/bloom.wgsl".into()
    }
...
pub struct ForgiaPpBloomPlugin;

impl Plugin for ForgiaPpBloomPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<BloomSettings>::default());
    }
}
