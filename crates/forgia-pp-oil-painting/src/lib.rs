//! forgia-pp-oil-painting — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpOilPaintingPlugin);
//! commands.spawn((Camera3d::default(), OilPaintingSettings::default()));
//! ```
...
impl FullscreenMaterial for OilPaintingSettings {
...
pub struct ForgiaPpOilPaintingPlugin;

impl Plugin for ForgiaPpOilPaintingPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<OilPaintingSettings>::default());
    }
}
