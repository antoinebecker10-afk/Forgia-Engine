//! forgia-pp-glitch — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpGlitchPlugin);
//! commands.spawn((Camera3d::default(), GlitchSettings::default()));
//! ```
...
impl FullscreenMaterial for GlitchSettings {
...
pub struct ForgiaPpGlitchPlugin;

impl Plugin for ForgiaPpGlitchPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<GlitchSettings>::default());
    }
}
