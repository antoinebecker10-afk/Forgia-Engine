//! forgia-pp-radial-blur — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpRadialBlurPlugin);
//! commands.spawn((Camera3d::default(), RadialBlurSettings::default()));
//! ```
...
impl FullscreenMaterial for RadialBlurSettings {
...
pub struct ForgiaPpRadialBlurPlugin;

impl Plugin for ForgiaPpRadialBlurPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<RadialBlurSettings>::default());
    }
}
