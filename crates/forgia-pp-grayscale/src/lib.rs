//! forgia-pp-grayscale — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpGrayscalePlugin);
//! commands.spawn((Camera3d::default(), GrayscaleSettings::default()));
//! ```
...
impl FullscreenMaterial for GrayscaleSettings {
...
pub struct ForgiaPpGrayscalePlugin;

impl Plugin for ForgiaPpGrayscalePlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<GrayscaleSettings>::default());
    }
}
