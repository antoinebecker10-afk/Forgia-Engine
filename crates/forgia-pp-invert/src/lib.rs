//! forgia-pp-invert — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpInvertPlugin);
//! commands.spawn((Camera3d::default(), InvertSettings::default()));
//! ```
...
impl FullscreenMaterial for InvertSettings {
...
pub struct ForgiaPpInvertPlugin;

impl Plugin for ForgiaPpInvertPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<InvertSettings>::default());
    }
}
