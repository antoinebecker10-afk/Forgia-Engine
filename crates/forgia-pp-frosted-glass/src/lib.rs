//! forgia-pp-frosted-glass — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpFrostedGlassPlugin);
//! commands.spawn((Camera3d::default(), FrostedGlassSettings::default()));
//! ```
...
impl FullscreenMaterial for FrostedGlassSettings {
...
pub struct ForgiaPpFrostedGlassPlugin;

impl Plugin for ForgiaPpFrostedGlassPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<FrostedGlassSettings>::default());
    }
}
