//! forgia-pp-gaussian-blur — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpGaussianBlurPlugin);
//! commands.spawn((Camera3d::default(), GaussianBlurSettings::default()));
//! ```
...
pub struct ForgiaPpGaussianBlurPlugin;

impl Plugin for ForgiaPpGaussianBlurPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<GaussianBlurSettings>::default());
    }
}
