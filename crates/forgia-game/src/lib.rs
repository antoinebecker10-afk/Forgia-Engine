...
/// Vue d'ensemble de l'eclairage du Hall — voir `castle_lighting_sensor`.
mod castle_lighting_sensor;
/// L'occlusion de contact du Hall — voir `castle_ssao`.
mod castle_ssao;
...
mod castle_props;
/// Le grain du sol du Hall — voir `castle_sol_detail`.
mod castle_sol_detail;
...
pub fn run_game() -> AppExit {
    ...
    #[cfg(feature = "dev-brp")]
    {
        app.add_plugins((
            RemotePlugin::default()
                .with_method(dev_brp_scenario::ACT_METHOD, dev_brp_scenario::act)
                .with_method(dev_brp_scenario::STOP_METHOD, dev_brp_scenario::stop)
                .with_method(
                    dev_brp_scenario::FOLLOW_FIRST_CAMP_METHOD,
                    dev_brp_scenario::follow_first_camp,
                )
                .with_method(
                    dev_brp_scenario::FOLLOW_CAMP_METHOD,
                    dev_brp_scenario::follow_camp,
                )
                .with_method(dev_brp_scenario::AIM_AT_METHOD, dev_brp_scenario::aim_at)
                .with_method(dev_brp_scenario::KEY_METHOD, dev_brp_scenario::key)
                .with_method(dev_brp_scenario::LOOK_METHOD, dev_brp_scenario::look)
                .with_method(
                    dev_brp_scenario::RELEASE_ALL_METHOD,
                    dev_brp_scenario::release_all,
                )
                .with_method(
                    dev_brp_scenario::SNAPSHOT_METHOD,
                    dev_brp_scenario::snapshot,
                ),
            RemoteHttpPlugin::default(),
        ));
        dev_brp_scenario::install(&mut app);
    }
    ...
    // Le sol rend a 5 texels/m sans lui — de loin le point le plus faible
    // du decor (mediane du reste : 194).
    app.add_plugins(castle_sol_detail::CastleSolDetailPlugin);
    app.add_plugins(castle_lighting_sensor::CastleLightingSensorPlugin);
    app.add_plugins(castle_ssao::CastleSsaoPlugin);
