//! forgia-pp-scanlines — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpScanlinesPlugin);
//! commands.spawn((Camera3d::default(), ScanlinesSettings::default()));
//! ```
...
impl FullscreenMaterial for ScanlinesSettings {
...
pub struct ForgiaPpScanlinesPlugin;

impl Plugin for ForgiaPpScanlinesPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<ScanlinesSettings>::default());
    }
}
