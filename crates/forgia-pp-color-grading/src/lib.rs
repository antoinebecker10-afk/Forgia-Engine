//! forgia-pp-color-grading — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpColorGradingPlugin);
//! commands.spawn((Camera3d::default(), ColorGradingSettings::default()));
//! ```
...
impl FullscreenMaterial for ColorGradingSettings {
...
pub struct ForgiaPpColorGradingPlugin;

impl Plugin for ForgiaPpColorGradingPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<ColorGradingSettings>::default());
    }
}
