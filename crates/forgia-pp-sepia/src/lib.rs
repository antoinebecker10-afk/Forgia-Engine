//! forgia-pp-sepia — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpSepiaPlugin);
//! commands.spawn((Camera3d::default(), SepiaSettings::default()));
//! ```
...
impl FullscreenMaterial for SepiaSettings {
...
pub struct ForgiaPpSepiaPlugin;

impl Plugin for ForgiaPpSepiaPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<SepiaSettings>::default());
    }
}
