//! forgia-pp-halftone — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpHalftonePlugin);
//! commands.spawn((Camera3d::default(), HalftoneSettings::default()));
//! ```
...
impl FullscreenMaterial for HalftoneSettings {
...
pub struct ForgiaPpHalftonePlugin;

impl Plugin for ForgiaPpHalftonePlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<HalftoneSettings>::default());
    }
}
