...
pub struct AutoRigStats {
    ...
    /// Permet au développeur de comparer visuellement vs AABB et identifier le décalage.
...
/// Interprète les stats pour produire un hint runtime pour le développeur. Vérifie
