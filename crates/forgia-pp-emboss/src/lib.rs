//! forgia-pp-emboss — Post-process effect.
//!
//! Bevy 0.18.1 — uses `FullscreenMaterialPlugin<T>`.
//!
//! Usage :
//! ```ignore
//! app.add_plugins(ForgiaPpEmbossPlugin);
//! commands.spawn((Camera3d::default(), EmbossSettings::default()));
//! ```
...
impl FullscreenMaterial for EmbossSettings {
...
pub struct ForgiaPpEmbossPlugin;

impl Plugin for ForgiaPpEmbossPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(FullscreenMaterialPlugin::<EmbossSettings>::default());
    }
}
