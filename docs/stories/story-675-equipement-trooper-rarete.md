...
> ou symboles qu'elle cite ont été retrouvés dans le dépôt (capteur `forgia2_castle_avatar.json`, fichier `boons_apply.rs`, symbole `EquipmentMods`).
...
>
> **Statut** : CANCELLED
> **État d'origine (périmé, cf bandeau)** : IN_PROGRESS (code livré, **runtime non validé**)
