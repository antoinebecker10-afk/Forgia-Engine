...
> ou symboles qu'elle cite ont été retrouvés dans le dépôt (fichier `meta_shop.rs`, symbole `MetaShopSave`).
...
> **État d'origine (périmé, cf bandeau)** : CODE-COMPLETE (2026-06-23) — validation runtime à faire
