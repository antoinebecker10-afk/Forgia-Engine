...
> **Statut** : ✅ DONE 2026-05-20 — 22/22 tests verts, 0 clippy `-D warnings`, scaffold 16 LOC → ~620 LOC peuplé. Selection logic deterministe testable. Tier 2 (wiring audio playback `bevy_kira_audio::play`) = story suivante.
> **Scale BMAD** : Standard
> **Date** : 2026-05-20
