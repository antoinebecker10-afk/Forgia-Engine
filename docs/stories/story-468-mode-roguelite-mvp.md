...
> ou symboles qu'elle cite ont été retrouvés dans le dépôt (capteur `forgia2_entities.json`, fichier `dialogue.rs`, symbole `BufferedEvent`).
...
> **État d'origine (périmé, cf bandeau)** : 🟡 PLAN AJUSTÉ — audit deep 5 agents (2026-05-19) identifié 3 BLOQUANTS + 8 AJUSTER, plan corrigé ci-dessous
