...
> ou symboles qu'elle cite ont été retrouvés dans le dépôt (fichier `arms.rs`, symbole `ViewmodelMotionTuning`).
...
>
> **Statut** : CANCELLED
> **État d'origine (périmé, cf bandeau)** : CODE COMPLETE — en attente validation runtime + commit
