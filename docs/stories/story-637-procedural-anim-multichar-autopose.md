...
> ou symboles qu'elle cite ont été retrouvés dans le dépôt (fichier `character.rs`, symbole `HumanoidAuto`).
...
> **État d'origine (périmé, cf bandeau)** : 🟡 IN_PROGRESS (créée 2026-06-30).
