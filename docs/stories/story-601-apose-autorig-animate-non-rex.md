...
> ou symboles qu'elle cite ont été retrouvés dans le dépôt (capteur `forgia2_auto_rig.json`, fichier `character.rs`).
...
>
> **Statut** : CANCELLED
> **État d'origine (périmé, cf bandeau)** : À FAIRE (rédigée 2026-06-16)
