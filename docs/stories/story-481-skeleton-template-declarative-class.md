...
> ou symboles qu'elle cite ont été retrouvés dans le dépôt (fichier `lib.rs`, symbole `BoneClass`).
...
> **État d'origine (périmé, cf bandeau)** : 🟡 EN COURS — audit hardcode 2026-05-20 a identifié 4 BLOQUANTS pattern "substring classification" dupliqué cross-crate
