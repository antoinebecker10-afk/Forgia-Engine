...
- V1 reste vivant en mode **bug-fix only**
...
- Le mainteneur veut un workspace neuf pour appliquer rigueur dès jour 1
- L'objectif "team-ready pour de futurs contributeurs" justifie la repensée structurelle
- Décision prise après débat 5 tours avec IA — pas un rewrite, un fork structurel
...
- Architecture explicite par crate dès le départ (futurs contributeurs)
...
Voir le plan « V2 Foundations » du 2026-05-14 (plan complet 7 phases, dépôt V1, non publié).
...
*Décision actée 2026-05-14 après débat 5 tours avec IA. Validation : structure créée immédiatement après cette ADR.*
