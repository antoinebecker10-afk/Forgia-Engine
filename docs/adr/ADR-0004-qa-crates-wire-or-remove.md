...
status: PROPOSED (décision Antoine requise)
date: 2026-06-10 (story-593 M1.6)
authors: [Claude (proposition), Antoine (décision)]
supersedes: []
related:
...
_À trancher par Antoine. Statut passera ACCEPTED-A / ACCEPTED-B avec date._
