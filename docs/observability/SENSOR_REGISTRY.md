...
| `forgia2_roguelite_state.json` | T0 | forgia-mode-roguelite | `src/sensor.rs:88` | 1Hz | run_state, wave, bots_alive, victory, weapon_levels + mastery_cap (story-668), room_kind + room_budget + room_density (story-669) | active |
