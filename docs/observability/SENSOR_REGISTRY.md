...
| `forgia2_expedition_cape.json` | T0 | forgia-mode-expedition | `src/cape.rs:250` | 1Hz | cape 3P : os de la chaine trouves, chaine prise par le solveur d'os-ressorts — alertes CAPE_SANS_RACINE / CHAINE_TROP_COURTE / SOLVEUR_INACTIF | active |
